--[[
Cyndic UI
Yes, This is a mercury UI edit, so credits to the owners.
]]
...
function Library:create(options)
	...
	creditsTab:credit{Name = "SquidSaysNo", Description = "Hub Owner"}
	creditsTab:credit{Name = "Server Side Script", Description = "Hub Owner"}
